...
class CarLoanFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // Переиспользуем тот же лейаут, но поменяем заголовки если нужно
        binding.layoutPropertyPrice.hint = "Стоимость автомобиля (₸)"
        ...
        binding.buttonViewSchedule.setOnClickListener {
            currentSchedule?.let { schedule ->
                ...
                findNavController().navigate(R.id.action_CarLoanFragment_to_SecondFragment, bundle)
            }
        }
    }

    private fun calculateCarLoan() {
        val carPrice = binding.editPropertyPrice.text.toString().toDoubleOrNull() ?: 0.0
        ...
        val principalAmount = carPrice - downPayment
